...
aft.geometry_data.rotor.airgap = 2 * 1e-3
aft.geometry_data.rotor.magnet_length = 2 * 1e-3 
aft.just_changed("geometry")

aft.calculation_data.n_point = 5
...
aft.adaptive_mesh_data.n_z_tooth_body = 5
