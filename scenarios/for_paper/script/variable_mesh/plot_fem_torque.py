...
def plot_fem_torque(file_name_array, io, figures_dir=None, mesh_indices=None):
    ...
    plt.margins(x=0)
    plt.tight_layout()
    plt.savefig(os.path.join(figures_dir, '3d_fem_torque_convergence.png'), dpi=300, bbox_inches='tight')
    plt.show()