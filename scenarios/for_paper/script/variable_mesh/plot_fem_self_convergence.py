...
def plot_fem_self_convergence(file_name_array, io, figures_dir=None):
    ...
    cogging_true = next((val for attr in ['cogging_fem', 'cogging_torque_fem', 'torque_fem_cogging'] 
    ...
    for file_name in file_name_array:
        ...
        cogging_data = next((val for attr in ['cogging_fem', 'cogging_torque_fem', 'torque_fem_cogging'] 
