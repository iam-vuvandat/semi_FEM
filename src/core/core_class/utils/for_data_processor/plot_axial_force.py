...
def plot_axial_force(data_processor, 
    ...
    has_mrn = hasattr(record, "axial_force") and record.axial_force is not None
    has_fem = hasattr(record, "axial_force_fem") and record.axial_force_fem is not None and show_fem
    ...
    if has_fem:
        ...
        record.axial_force_harmonic_fem = np.vstack((amps_fem, h_orders))
    ...
    if has_mrn:
        ...
        record.axial_force_harmonic = np.vstack((amps_mrn, h_orders))
