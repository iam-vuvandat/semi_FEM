from core.motor_type.utils.for_export_maxwell import solve_standard_step
import paths
import numpy as np
import math 
pi = math.pi
...
from src.core.motor_type.utils.for_export_maxwell.solve_standard_step import solver_standard_step
...
def export_to_maxwell(motor, callback=None):
    ...
    create_custom_mesh(m3d = m3d, motor = motor, exclude = region )
