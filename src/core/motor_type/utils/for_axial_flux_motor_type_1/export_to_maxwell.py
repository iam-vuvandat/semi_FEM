...
from src.core.motor_type.utils.for_axial_flux_motor_type_1.for_export_maxwell.apply_master_slave import apply_master_slave
...
def export_to_maxwell(motor, callback=None):
    ...
    #region =  apply_master_slave(m3d=m3d,motor=motor)
