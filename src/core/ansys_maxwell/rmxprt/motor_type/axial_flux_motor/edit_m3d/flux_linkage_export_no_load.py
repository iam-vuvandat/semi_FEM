...
def flux_linkage_export_no_load(motor, m3d):
    ...
    report_name = "Flux_Linkage_Report_No_Load_FEM"
    ...
    motor.record.flux_linkage_no_load_fem = combined_data.copy()
    motor.record.back_emf_no_load_fem = back_emf.copy()
    print(f"\033[92mSuccess: Flux Linkage and Back-EMF no_load exported (Offset: {offset:.4f} rad)\033[0m")