...
def axial_force_export_no_load(motor, m3d):
    ...
    report_name = "Axial_Force_Report_No_Load_FEM"
    ...
    motor.record.axial_force_no_load_fem = np.vstack((force_val, current_positions))
    motor.record.average_axial_force_no_load_fem = np.mean(force_val)
